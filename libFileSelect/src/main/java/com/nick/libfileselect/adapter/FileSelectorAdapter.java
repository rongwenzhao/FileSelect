package com.nick.libfileselect.adapter;
...
import com.nick.libfileselect.provide.dateFormat.FileDateProvideDefault;
import com.nick.libfileselect.provide.icon.FileIconProvide;
import com.nick.libfileselect.provide.icon.FileIconProvideDefault;
import com.nick.libfileselect.provide.size.FileSizeProvide;
import com.nick.libfileselect.provide.size.FileSizeProvideDefault;
...
public class FileSelectorAdapter extends RecyclerView.Adapter<FileSelectorAdapter.FileViewHolder> {
    ...
    private FileIconProvide fileIconProvide = new FileIconProvideDefault();

    //private FileDateProvideDefault fileDateProvideDefault = new FileDateProvideDefault();
    private FileDateProvide fileDateProvide = new FileDateProvideDefault();

    //private FileSizeProvideDefault fileSizeProvideDefault = new FileSizeProvideDefault();
    private FileSizeProvide fileSizeProvide = new FileSizeProvideDefault();
    ...
    public FileViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.file_select_list_item, viewGroup, false);
