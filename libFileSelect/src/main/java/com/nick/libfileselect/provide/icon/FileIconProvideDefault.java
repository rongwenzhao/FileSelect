...
public class FileIconProvideDefault extends FileIconProvide {
    ...
    //文件夹图片 和 未知文件类型图片
    private static final int TYPE_FOLDER = R.drawable.fileselector_file_type_folder;
    private static final int TYPE_UNKNOWN = R.drawable.fileselector_file_type_unknow;
